            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        <div>
                            <formmethod="POST" action="{{ route('signin.authenticate') }}">
                                @csrf
                                <div class="space-y-5">
                                    <!-- Email -->
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Nama Akun<span class="text-error-500">*</span>
                                        </label>
                                        <input type="email" id="email" name="email" placeholder="Masukkan nama akun anda"
