    ...
    <div class="space-y-6 max-h-[75vh] overflow-y-auto pr-2">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm mb-1">Nama Lembaga</label>
                    <input
                        type="text"
                        name="nama_lembaga"
                ...
                <div>
                    <label class="block text-sm mb-1">Nama Kepala SPPG</label>
                    <input
                        type="text"
                ...
                <div>
                    <label class="block text-sm mb-1">Nama Akuntan SPPG</label>
                    <input
                        type="text"
                        name="nama_akuntan"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea
                        name="alamat"
                        rows="3"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2">{{ old('alamat', $dapur->alamat) }}</textarea>
                </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm mb-1">Nama Yayasan</label>
                    <input
                        type="text"
                        name="nama_yayasan"
                ...
                <div>
                    <label class="block text-sm mb-1">Ketua Yayasan</label>
                    <input
                        type="text"
                        name="ketua_yayasan"
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm mb-1">Nomor Rekening / VA</label>
                    <input
                        type="text"
                        name="nomor_rekening"
                ...
                <div>
                    <label class="block text-sm mb-1">Tempat Pelaporan</label>
                    <input
                        type="text"
